...
class WalletControllerTest {
    ...
    void before() {
        ...
        wallets = Helper.createWalletListMock( customers );
    ...
    void shouldReturn201_WhenCreateNewWallet() throws Exception {
        ...
        int indexWallet = (int)RandomGenerator.generateIntNumberByInterval(0, wallets.size() - 1);
    ...
    void sholdReturn200_WhenRequestListWalletsByCustomerId() throws Exception {
        ...
        int indexCustomer = (int)RandomGenerator.generateIntNumberByInterval(0, uniqueCustomers.size() - 1);
